class UI{
  ...
  paint(details){
    ...
    this.temp1.textContent= `${details.list[0].main.temp}°c`
    ...
    this.wind1.textContent=`Wind speed: ${details.list[0].wind.speed}km/h`
    ...
    this.temp2.textContent= `${details.list[6].main.temp}°c`
    ...
    this.wind5.textContent= `Wind speed: ${details.list[35].wind.speed}km/h`
